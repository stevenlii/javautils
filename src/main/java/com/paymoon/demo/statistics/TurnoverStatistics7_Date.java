...
//*
// */
//public class TurnoverStatistics7_Date {
//
//	/**
//	 * @param args
...
//		new TurnoverStatistics7_Date().connectDB2();
//		MailSend.send();
//	}
//
...
//						sheet.addCell(label);
//				String transRateSQL = "select MERID,GOODSID,BANKID,ORDERSTATE,COUNT(ORDERSTATE) ORDERCOUNT from UMPAY.T_UPORDER_" + tableSuf + " where ORDERDATE='" + todayyyyMMdd + "' and MERID='"+merid +"' and GOODSID='"+goodsid+"' and BANKID='"+bankid+"'   group by MERID,GOODSID,BANKID,ORDERSTATE";
