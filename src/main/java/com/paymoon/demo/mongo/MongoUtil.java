...
public class MongoUtil {  
    ...
    public static DB getdb(){  
    	String mongoDBName = MyProp.getVariable("xxx.mongo.db", "xxx");
        try {
    ...
    public static MongoClient getMongos() throws UnknownHostException {  
        return MongoDBUtil.instance.getMongoClient();  
    }  
