...
public class SystemConfigUtil {
    ...
    public static Properties getProperties() throws IOException {
        ...
        InputStream in = Object.class.getResourceAsStream("/runtime.properties");
        prop.load(in);
        return prop;
    }
    ...
    public static void setDBConfig(Properties config) {
        ...
        String valueLocalhost = config.getProperty("menu.localhost.url");
        System.out.println(valueLocalhost);
        //迭代配置文件中的配置，并放到map中
