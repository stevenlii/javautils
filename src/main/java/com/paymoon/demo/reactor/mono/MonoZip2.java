 ...
 *
 */
public class MonoZip2 {
	public static void main(String[] args) {
		Mono<String> aaInteger = Mono.just("a");
		Mono<String> bbInteger = Mono.just("b");
		Mono<String> empInteger = Mono.just("");
		Mono<Tuple3<String, String, String>> zipResult = Mono.zip(aaInteger, bbInteger,empInteger);
		Tuple3<String, String, String> merge = zipResult.block();
