...
//		getMatchedStr(getClazzName());
		...
		System.out.println(getMatchedAndReplaceStr2(getClazzName3(),person));
	}
	...
	public static String getClazzName3() {
		String clazzName3 = "我已经{{age}}岁了{{age}}岁了";
		return clazzName3;
	}
	/**
	 * 匹配花括号
	...
	public static String getMatchedAndReplaceStr2(String title,Person person) {
		...
		while (matcher.find()) {
				/* 5.属性值处理，默认值空串 */
				String replaceStr = "";
				Integer gcnt = matcher.groupCount();
				for (int i = 0; i <= 1; i++) {
					System.out.println(matcher.group(i));
				}
				String group1 = matcher.group(1);
				if (detailMap.get(group1) != null) {
					replaceStr = String.valueOf(detailMap.get(group1));
				}
