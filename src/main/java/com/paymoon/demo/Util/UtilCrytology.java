...
public class UtilCrytology {
	...
	public static String getKey() {
		if (key == null)
			key=MyProp.getVariable("ucid.accesskey", "ucloudv5");
		return key;
	}
	 ...
	 * @throws Exception
	 */
	protected static String decrypt(String data, String key) throws IOException,
			Exception {
		if (data == null)
			return null;
	...
	public static void main(String[] args){
		System.out.println(decrypt("Upy0o123"));;//ucloudv5
		System.out.println(encrypt("Upy0o123"));;//ucloudv5
	}
}
